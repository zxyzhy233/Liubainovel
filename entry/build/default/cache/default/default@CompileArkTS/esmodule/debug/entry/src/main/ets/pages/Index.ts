...
class Index extends ViewPU {
    ...
    private async loadBook() {
        try {
            ...
            this.getUIContext()
                .getPromptAction()
                .showToast({ message: { "id": 16777229, "type": 10003, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" }, duration: 2000 });
        }
        catch (err) {
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777305, "type": 20000, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" });
            Image.width(32);
            Image.height(32);
            Image.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777313, "type": 20000, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" });
            Image.width(32);
            Image.height(32);
            Image.onClick(() => {
                        ...
                        const forEachItemGenFunction = _item => {
                            const book = _item;
                            {
                                ...
                                const observedDeepRender = () => {
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Image.create(book.coverPath || { "id": 16777314, "type": 20000, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" });
                                        Image.width('100%');
                                        Image.aspectRatio(0.75);
                                        Image.borderRadius(8);
                                        Image.backgroundColor({ "id": 16777239, "type": 10001, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" });
                                    }, Image);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        If.create();
                                        if (this.isEditMode) {
                                            this.ifElseBranchUpdateFunction(0, () => {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    Image.create(this.selectedBooks.includes(book.id) ? { "id": 16777265, "type": 20000, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" } : { "id": 16777266, "type": 20000, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" });
                                                    Image.width(24);
                                                    Image.height(24);
                        ...
                        const forEachItemGenFunction = _item => {
                            const book = _item;
                            {
                                ...
                                const observedDeepRender = () => {
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Image.create(book.cover || { "id": 16777314, "type": 20000, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" });
                                        Image.width('100%');
                                        Image.aspectRatio(0.75);
                                        Image.borderRadius(8);
                                        Image.backgroundColor({ "id": 16777239, "type": 10001, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" });
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        if (this.isEditMode) {
                                            this.ifElseBranchUpdateFunction(0, () => {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    Image.create(this.selectedOnlineBooks.includes(book.id) ? { "id": 16777265, "type": 20000, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" } : { "id": 16777266, "type": 20000, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" });
                                                    Image.width(24);
                                                    Image.height(24);
                                                    Image.margin({ top: 4, right: 4 });
                                                }, Image);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        if (this.isExportMode) {
                                            this.ifElseBranchUpdateFunction(0, () => {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    Image.create(this.selectedExportBooks.includes(book.id) ? { "id": 16777265, "type": 20000, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" } : { "id": 16777266, "type": 20000, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" });
                                                    Image.width(24);
                                                    Image.height(24);
                                                    Image.margin({ top: 4, right: 4 });
                                                }, Image);
    ...
    popupWithButtonBuilder(parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777282, "type": 20000, params: [], "bundleName": "liubai.yuedu.hos", "moduleName": "entry" });
            Image.width(20);
            Image.height(20);
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {

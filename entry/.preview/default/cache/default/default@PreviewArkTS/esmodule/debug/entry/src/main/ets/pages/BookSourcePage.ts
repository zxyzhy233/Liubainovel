...
class BookSourcePage extends ViewV2 {
    ...
    private buildHeader(parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(631:5)", "entry");
            Row.width('100%');
            Row.height(56);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(633:7)", "entry");
            // 返回按钮
            Button.width(40);
            // 返回按钮
            Button.height(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('👈');
            Text.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(634:9)", "entry");
            Text.fontSize(20);
        }, Text);
        Text.pop();
        // 返回按钮
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 标题
            Text.create('鹿析管理');
            Text.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(645:7)", "entry");
            // 标题
            Text.fontSize(20);
            // 标题
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 添加按钮
            Button.createWithChild();
            Button.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(653:7)", "entry");
            // 添加按钮
            Button.width(40);
            // 添加按钮
            Button.height(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('➕');
            Text.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(654:9)", "entry");
            Text.fontSize(20);
        }, Text);
        Text.pop();
        // 添加按钮
    ...
    private buildBookSourceCard(source: BookSource, parent = null): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(692:5)", "entry");
            Column.width('100%');
            Column.padding(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 鹿析信息行
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(694:7)", "entry");
            // 鹿析信息行
            Row.width('100%');
            // 鹿析信息行
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(695:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(697:11)", "entry");
            // 鹿析名称
            Text.fontSize(16);
            // 鹿析名称
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(705:11)", "entry");
            // 鹿析URL
            Text.fontSize(12);
            // 鹿析URL
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Toggle.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(718:9)", "entry");
            // 启用开关
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 描述和更新时间
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(727:7)", "entry");
            // 描述和更新时间
            Row.width('100%');
            // 描述和更新时间
            Row.margin({ bottom: 8, top: 0, left: 0, right: 0 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(728:9)", "entry");
            Text.fontSize(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(735:9)", "entry");
            Text.fontSize(10);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 操作按钮
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(743:7)", "entry");
            // 操作按钮
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('测试');
            Button.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(744:9)", "entry");
            Button.fontSize(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(754:9)", "entry");
            Button.fontSize(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(765:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('删除');
            Button.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(767:9)", "entry");
            Button.fontSize(12);
    ...
    popupWithButtonBuilder(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(792:5)", "entry");
            Column.width(160);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(793:7)", "entry");
            Row.height(50);
            Row.width('100%');
            Row.justifyContent(FlexAlign.Start);
            Row.alignItems(VerticalAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(794:9)", "entry");
            Image.width(20);
            Image.height(20);
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('新建鹿析');
            Text.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(797:9)", "entry");
            Text.fontSize(18);
        }, Text);
        Text.pop();
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(810:7)", "entry");
            Row.height(50);
            Row.width('100%');
            Row.justifyContent(FlexAlign.Start);
            Row.alignItems(VerticalAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(811:9)", "entry");
            Image.width(20);
            Image.height(20);
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('导入鹿析');
            Text.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(814:9)", "entry");
            Text.fontSize(18);
        }, Text);
        Text.pop();
        Row.pop();
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(831:5)", "entry");
            Column.width('100%');
            Column.height('100%');
            ...
            if (this.isLoading) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 加载状态
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(838:9)", "entry");
                        // 加载状态
                        Column.width('100%');
                        // 加载状态
                        Column.layoutWeight(1);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Progress.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(839:11)", "entry");
                        Progress.width(40);
                        Progress.height(40);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('正在加载鹿析...');
                        Text.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(843:11)", "entry");
                        Text.fontSize(14);
                        Text.fontColor('#718096');
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 空状态
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(853:9)", "entry");
                        // 空状态
                        Column.width('100%');
                        // 空状态
                        Column.layoutWeight(1);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('🦌');
                        Text.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(854:11)", "entry");
                        Text.fontSize(48);
                        Text.margin({ top: 12, bottom: 0, left: 0, right: 0 });
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('暂无鹿析');
                        Text.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(857:11)", "entry");
                        Text.fontSize(16);
                        Text.fontColor('#718096');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(861:11)", "entry");
                        Button.fontSize(14);
                ...
                this.ifElseBranchUpdateFunction(2, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 鹿析列表
                        List.create();
                        List.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(876:9)", "entry");
                        // 鹿析列表
                        List.width('100%');
                        // 鹿析列表
                        List.layoutWeight(1);
                        ...
                        const forEachItemGenFunction = _item => {
                            const source = _item;
                            {
                                ...
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ...
                                    ListItem.debugLine("entry/src/main/ets/pages/BookSourcePage.ets(878:13)", "entry");
                                };

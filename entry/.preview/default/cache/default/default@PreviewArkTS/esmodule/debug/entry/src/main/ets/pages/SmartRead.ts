...
class SmartReadUI extends ViewPU {
    ...
    initialRender(): void {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SmartRead.ets(14:5)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 顶部状态栏
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SmartRead.ets(16:7)", "entry");
            // 顶部状态栏
            Row.height(50);
            // 顶部状态栏
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('智能朗读');
            Text.debugLine("entry/src/main/ets/pages/SmartRead.ets(17:9)", "entry");
            Text.fontSize(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 小说封面与标题区域
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/SmartRead.ets(27:7)", "entry");
            // 小说封面与标题区域
            Stack.width('100%');
            // 小说封面与标题区域
            Stack.height(300);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/SmartRead.ets(28:9)", "entry");
            Image.width('90%');
            Image.height(300);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SmartRead.ets(34:9)", "entry");
            Column.width('90%');
            Column.height(300);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/SmartRead.ets(35:11)", "entry");
            Text.fontSize(24);
            Text.fontWeight(FontWeight.Bold);
            Text.width('90%');
            Text.textAlign(TextAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/SmartRead.ets(40:11)", "entry");
            Text.fontSize(18);
            Text.width('90%');
            Text.textAlign(TextAlign.Center);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('海底的秘密/著');
            Text.debugLine("entry/src/main/ets/pages/SmartRead.ets(44:11)", "entry");
            Text.fontSize(14);
            Text.width('90%');
            Text.textAlign(TextAlign.Center);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 播放进度条
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SmartRead.ets(58:7)", "entry");
            // 播放进度条
            Row.height(50);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('06:25');
            Text.debugLine("entry/src/main/ets/pages/SmartRead.ets(59:9)", "entry");
            Text.fontSize(16);
            Text.width(50);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Slider.create();
            Slider.debugLine("entry/src/main/ets/pages/SmartRead.ets(62:9)", "entry");
            Slider.width('80%');
        }, Slider);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('09:09');
            Text.debugLine("entry/src/main/ets/pages/SmartRead.ets(64:9)", "entry");
            Text.fontSize(16);
            Text.width(50);
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 播放控制按钮
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SmartRead.ets(71:7)", "entry");
            // 播放控制按钮
            Row.height(50);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('上一章');
            Button.debugLine("entry/src/main/ets/pages/SmartRead.ets(72:9)", "entry");
            Button.width(50);
            Button.height(50);
        }, Button);
        Button.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/SmartRead.ets(75:9)", "entry");
            Button.width(50);
            Button.height(50);
        }, Button);
        Button.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/SmartRead.ets(78:9)", "entry");
            Button.width(50);
            Button.height(50);
        }, Button);
        Button.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/SmartRead.ets(81:9)", "entry");
            Button.width(50);
            Button.height(50);
        }, Button);
        Button.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 功能按钮区域
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SmartRead.ets(88:7)", "entry");
            // 功能按钮区域
            Row.height(50);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('目录');
            Button.debugLine("entry/src/main/ets/pages/SmartRead.ets(89:9)", "entry");
            Button.width(50);
            Button.height(50);
        }, Button);
        Button.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/SmartRead.ets(92:9)", "entry");
            Button.width(50);
            Button.height(50);
        }, Button);
        Button.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/SmartRead.ets(95:9)", "entry");
            Button.width(50);
            Button.height(50);
        }, Button);
        Button.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/SmartRead.ets(98:9)", "entry");
            Button.width(50);
            Button.height(50);
        }, Button);
        Button.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 当前章节提示
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SmartRead.ets(105:7)", "entry");
            // 当前章节提示
            Row.height(50);
            // 当前章节提示
            Row.backgroundColor(Color.Gray);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('边听边读');
            Text.debugLine("entry/src/main/ets/pages/SmartRead.ets(106:9)", "entry");
            Text.fontSize(16);
            Text.width(100);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/SmartRead.ets(109:9)", "entry");
            Text.fontSize(16);
            Text.width('70%');
            Text.textAlign(TextAlign.Center);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('下一章');
            Button.debugLine("entry/src/main/ets/pages/SmartRead.ets(113:9)", "entry");
            Button.width(50);
            Button.height(50);
        }, Button);
        Button.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 声音选项按钮
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SmartRead.ets(122:7)", "entry");
            // 声音选项按钮
            Row.height(50);
            // 声音选项按钮
            Row.backgroundColor(Color.Gray);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/SmartRead.ets(123:9)", "entry");
            Button.width('33%');
            Button.height(50);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/SmartRead.ets(127:9)", "entry");
            Button.width('33%');
            Button.height(50);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/SmartRead.ets(131:9)", "entry");
            Button.width('33%');
            Button.height(50);
...
registerNamedRoute(() => new SmartReadUI(undefined, {}), "", { bundleName: "liubai.yuedu.hos", moduleName: "entry", pagePath: "pages/SmartRead", pageFullPath: "entry/src/main/ets/pages/SmartRead", integratedHsp: "false", moduleType: "followWithHap" });
